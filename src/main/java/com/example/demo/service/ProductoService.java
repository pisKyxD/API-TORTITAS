...
public class ProductoService {
    ...
    public List<Producto> findByCategoriaAndSabor(Long idCategoria, Long idSabor) {
        return productoRepository.findByCategoriaIdCategoriaAndSaborIdSabor(idCategoria, idSabor);
    }
